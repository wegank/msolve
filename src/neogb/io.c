        ...
        )
{
    ...
    if (st->nev > 0) {
        st->ops.initial_input_cmp = initial_input_cmp_be;
        st->ops.initial_gens_cmp = initial_gens_cmp_be;
        st->ops.monomial_cmp = monomial_cmp_be;
        st->ops.spair_cmp = spair_cmp_be;
        st->ops.hcm_cmp = hcm_cmp_pivots_be;
    } else if (st->mo == 1) {
        st->ops.initial_input_cmp = initial_input_cmp_lex;
        st->ops.initial_gens_cmp = initial_gens_cmp_lex;
        st->ops.monomial_cmp = monomial_cmp_lex;
        st->ops.spair_cmp = spair_cmp_deglex;
        st->ops.hcm_cmp = hcm_cmp_pivots_lex;
    } else {
        st->ops.initial_input_cmp = initial_input_cmp_drl;
        st->ops.initial_gens_cmp = initial_gens_cmp_drl;
        st->ops.monomial_cmp = monomial_cmp_drl;
        st->ops.spair_cmp = spair_cmp_drl;
        st->ops.hcm_cmp = hcm_cmp_pivots_drl;
    }

    st->ops.normalize_initial_basis = dispatch_normalize_initial_basis;
    st->ops.sba_linear_algebra = dispatch_sba_linear_algebra;
    st->ops.exact_linear_algebra = dispatch_exact_linear_algebra;
    st->ops.linear_algebra = dispatch_linear_algebra;
    st->ops.application_linear_algebra = dispatch_application_linear_algebra;
    st->ops.trace_linear_algebra = dispatch_trace_linear_algebra;
    st->ops.interreduce_matrix_rows = dispatch_interreduce_matrix_rows;
    st->ops.reduce_dense_row_by_old_pivots_ff_32 =
        dispatch_reduce_dense_row_by_old_pivots_ff_32;
    st->ops.sba_reduce_dense_row_by_known_pivots_sparse_ff_32 =
        dispatch_sba_reduce_dense_row_by_known_pivots_sparse_ff_32;
    st->ops.reduce_dense_row_by_known_pivots_sparse_ff_32 =
        dispatch_reduce_dense_row_by_known_pivots_sparse_ff_32;
    st->ops.trace_reduce_dense_row_by_known_pivots_sparse_ff_32 =
        dispatch_trace_reduce_dense_row_by_known_pivots_sparse_ff_32;
    st->ops.reduce_dense_row_by_all_pivots_ff_32 =
        dispatch_reduce_dense_row_by_all_pivots_ff_32;
    st->ops.reduce_dense_row_by_dense_new_pivots_ff_32 =
